...
ALTER TABLE Ball
DROP CONSTRAINT [BallName_UNIQUE]

ALTER TABLE Arsenal
ADD arsenalID bigint PRIMARY KEY IDENTITY(1,1) NOT NULL;
GO;

ALTER TABLE Ball
ADD ArsenalID bigint
GO;

ALTER TABLE Ball 
ADD CONSTRAINT Ball_Arsenal_ID
Foreign KEY (ArsenalID)
REFERENCES Arsenal (arsenalID)
GO;
